...
class DB_entity(object):
    '''
    Représente une entité qui intéragit avec la base de données.
    :ivar conn: un objet connexion à une base de données.
    '''
    class __Singleton:
        def __init__(self):
        ...
        def getClientList(self):
            '''
            :return: Retourne la liste des clients sous forme d'une liste de dictionnaires.
        ...
        def getClientAnnounces(self, id_client):
            ...
            :return: la liste des appels d'offres attribués au client qui a l'identifiant <id_client>.
            '''
            with self.conn.cursor(oursql.DictCursor) as cursor:
                query = '''
        ...
        def getAnnounceList(self):
            '''
            :return: la liste de tous les appels d'offres.
            '''
            with self.conn.cursor(oursql.DictCursor) as cursor:
        ...
        def getAnnounceAttributed(self):
            '''
            :return: la liste de tous les appels d'offres qui ont été attribués à des clients.
            '''
            with self.conn.cursor(oursql.DictCursor) as cursor:
        ...
        def getAnnounceUnattributed(self):
            '''
            :return: la liste de tous les appels d'offres qui n'ont pas été attribués à des clients.
            '''
            with self.conn.cursor(oursql.DictCursor) as cursor:
